  ...
  return (
    <section className="relative">
      <div className="relative w-full">
        ...
        {/* Narandžasti baner ispod slike — "OD SVJETLA DO ŽIVOTA" */}
        <div className="bg-amber-deep text-cream text-center py-4 px-5" style={{ borderTop: "2px solid #452D18", borderBottom: "2px solid #452D18" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            ...
            style={{ height: "80px" }}
          />
          <div className="text-[11px] font-bold tracking-[0.28em] uppercase mb-1">
            SELO U ZALEĐU HERCEG NOVOG
          </div>
          <div
          ...
          <div className="text-[12px] tracking-[0.08em] text-cream/90">
            SELO KOJE SE BUDI IZ ZABORAVA
          </div>
        </div>
      </div>
      ...
      <div className="container-content pb-6">
        <div className="flex flex-wrap gap-3 justify-center">
          ...
          <div className="stat-chip bg-forest text-cream" style={{ transform: "rotate(-1deg)", background: "#55704F", borderColor: "#452D18" }}>
      ...
      <div className="container-content pb-10">
        ...
        >
          ...
          <div>
            <div className="text-[10.5px] font-bold uppercase tracking-[0.16em] text-accent">ČOVJEK IZA SVEGA</div>
            <div className="mt-0.5 mb-1.5" style={{ fontFamily: "var(--font-alfa), Georgia, serif", fontSize: "17px" }}>
              JOVICA TUŠUP
            </div>
            <p className="text-[13.5px] leading-snug text-ink/85">
              Porijeklom iz Svrčuga, odbio je da gleda kako mu selo nestaje. Njegova misija: spasiti Svrčuge od zaborava — svjetlo po svjetlo, projekat po projekat.
            </p>
            <Link href={`/${locale}/prica`} className="mt-2 inline-block text-sm font-semibold text-amber-deep hover:underline">
              Pročitaj Jovičinu priču →
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="container-content pb-12 flex flex-wrap gap-3 justify-center">
        ...
        <Link href={`/${locale}#plan`} className="btn-secondary">
          {h.ctaSecondary}
        </Link>
      </div>
    </section>
